                ...
                @foreach($reviews as $review)
                    ...
                    <article class="review-card">
                        ...
                        @if(!empty($review->attachment_path))
                            @php
                                $reviewAttachmentUrl = route('reviews.attachment', ['filename' => basename($review->attachment_path)]) . '?v=' . time();
                                $reviewAttachmentImage = \Illuminate\Support\Str::startsWith((string) ($review->attachment_mime ?? ''), 'image/');
                            @endphp

                            <div class="review-attachment">
                                @if($reviewAttachmentImage)
                                    <img src="{{ $reviewAttachmentUrl }}" alt="Review attachment" class="review-attachment-image">
                                @endif

                                <a href="{{ $reviewAttachmentUrl }}" target="_blank" class="review-attachment-link">
